...
void	push(t_stack *from, t_stack *to)
{
	...
	ft_memmove(&from->values[0], &from->values[1], (sizeof(int)
			* (from->size - 1)));
	ft_memmove(&from->index[0], &from->index[1], (sizeof(int)
			* (from->size - 1)));
	from->size--;
	to->size++;
}
...
void	rotate(t_stack *stack)
{
	...
	temp_val = stack->values[0];
	temp_idx = stack->index[0];
	ft_memmove(&stack->values[0], &stack->values[1], (sizeof(int)
			* (stack->size - 1)));
	ft_memmove(&stack->index[0], &stack->index[1], (sizeof(int)
			* (stack->size - 1)));
...
void	rev_rotate(t_stack *stack)
{
	...
	ft_memmove(&stack->values[1], &stack->values[0], (sizeof(int)
			* (stack->size - 1)));
	ft_memmove(&stack->index[1], &stack->index[0], (sizeof(int)
			* (stack->size - 1)));
